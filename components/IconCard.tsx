...
export default function IconCard({ image, imageAlt, description }: IconCardProps) {
  return (
    <div className="flex flex-col items-center text-center gap-3 sm:gap-6">
      <div className="relative w-[80px] h-[80px] sm:w-[120px] sm:h-[120px] md:w-[140px] md:h-[140px] rounded-full bg-[#374af0] flex items-center justify-center">
        <div className="absolute -inset-6 sm:-inset-10 md:-inset-12 flex items-center justify-center">
          <Image
            src={image}
            alt={imageAlt}
            width={350}
