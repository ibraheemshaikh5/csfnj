    ...
    <div className="mt-12 mb-8">
          ...
          <div className="p-6">
            <div className="flex items-center gap-6">
              ...
              <div className="flex-shrink-0">
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden w-[180px] h-[180px] flex items-center justify-center">
                  <Image
      ...
      <div className="text-center mt-8">
        <div className="inline-flex items-center gap-2 bg-green-50 text-green-700 px-6 py-3 rounded-full">
          ...
          <p className="font-medium">We accept Zakat & Sadaqah - 100% of Donations go to the cause!</p>
        </div>
      </div>
    </div>
  );
